...
Die Rakete startet senkrecht vom Boden (Meereshöhe) aus dem Stillstand und muss schliesslich eine horizontale Flugrichtung sowie eine ausreichende Geschwindigkeit erreichen, um im Orbit zu bleiben. Die wichtigsten Zustands- und Steuervariablen sind:
...
Für die Erde beträgt der Gravitationsparameter \(\mu_{\oplus} = GM_{\oplus} = 3.99 \times 10^5 \, \text{km}^3/\text{s}^2\). Raumfahrzeuge in niedrigen Umlaufbahnen (Low Earth Orbit, LEO), wie etwa die Internationale Raumstation (ISS), befinden sich typischerweise in einer Höhe von etwa 400\,km und benötigen eine Geschwindigkeit von etwa 7.67\,km/s, um im Orbit zu bleiben.
