...
%
%\begin{itemize}
%	\item \textbf{Systemgleichung}: Die Dynamik der Rakete wird durch eine Differentialgleichung beschrieben, bei der die Zustandsgrössen \(x(t)\) und die Steuergrössen \(u(t)\) interagieren.
%	\item \textbf{Kostenfunktional}: Das Kostenfunktional beschreibt die zu minimierenden Verluste, einschliesslich des Treibstoffverbrauchs und der Verluste durch Schwerkraft und Luftwiderstand. Es besteht aus einem Integral über die Laufkosten und einem Randterm, der die Endbedingungen festlegt.
...
\begin{figure}
	...
	\caption{Langzeit Beleuchtung eines Raketen Starts \cite{leo:spacex_trajectory_2015}.}
