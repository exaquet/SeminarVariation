...
Wie bereits in Abschnitt \textbf{18.3} eingeführt, werden diese Verluste durch folgende Gleichung beschrieben:
\[
v_f = v_* \ln \left(\frac{m_0}{m_f}\right) - 2F_* \int_0^{t_f} \frac{\sin^2\left(\frac{\alpha}{2}\right)}{m} \, dt - \dots
\]
